...
import { $createSketchNode, $isSketchNode, SketchNode, SketchPayload } from '../../nodes/SketchNode/SketchNode';
...
export default function SketchPlugin(): React.ReactElement | null {
