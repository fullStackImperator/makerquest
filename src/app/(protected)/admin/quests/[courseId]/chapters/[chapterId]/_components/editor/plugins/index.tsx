...
import { ListPlugin } from './ListPluginNew'
...
import ListMaxIndentLevelPlugin from './ListPluginNew/ListMaxIndentLevelPlugin'
...
export const EditorPlugins: React.FC<{
  ...
  placeholder?:
    | React.ReactElement
    | ((isEditable: boolean) => React.ReactElement | null)
    | null
  onChange?: (
