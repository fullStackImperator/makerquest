...
// import type { ListType } from '../../nodes/ListNodeNew'
...
import { $isParagraphNode, LexicalEditor } from 'lexical'
...
import {
  ...
  $isImageNode,
  ImageNode,
} from '../../nodes/ImageNodeNew/ImageNode'
import {
  $createGraphNode,
  $isGraphNode,
  GraphNode,
...
import {
  ...
  $isStickyNode,
  StickyNode,
} from '../../nodes/StickyNodeNew/StickyNode'
...
export const CODE: ElementTransformer = {
  ...
  replace: (parentNode, children, match, isImport) => {
    ...
    if (isImport) {
      ...
      const closingTagIndex = nextSiblings.findIndex((node) =>
        node.getTextContent().endsWith('```')
      )
