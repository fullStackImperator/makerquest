...
const TranscriptAlert = ({ transcript }: { transcript: string }) => {
  return createPortal(
    <div
      className="fixed bottom-4 left-1/2 z-[9999] w-[calc(100%-32px)] max-w-md -translate-x-1/2 rounded-md border border-green-200 bg-green-50 px-4 py-2 text-center text-sm text-green-800 dark:border-green-800 dark:bg-green-950/50 dark:text-green-200"
      role="status"
    >
      {transcript}
    </div>,
